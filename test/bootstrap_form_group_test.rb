...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test "changing the label text via the label option parameter" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email Address</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
  ...
  test "hiding a label" do
    expected = %{<div class="form-group"><label class="sr-only required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
  ...
  test "adding a custom label class via the label_class parameter" do
    expected = %{<div class="form-group"><label class="btn required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
  ...
  test "adding a custom label and changing the label text via the html_options label hash" do
    expected = %{<div class="form-group"><label class="btn required" for="user_email">Email Address</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
  ...
  test "preventing a label from having the required class" do
    expected = %{<div class="form-group"><label class="" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, skip_required: true)
  end

  test "adding prepend text" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><div class="input-group"><div class="input-group-prepend"><span class="input-group-text">@</span></div><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, prepend: '@')
  end

  test "adding append text" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><div class="input-group"><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><div class="input-group-append"><span class="input-group-text">.00</span></div></div></div>}
  ...
  test "adding both prepend and append text" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</div></div><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><div class="input-group-append"><span class="input-group-text">.00</span></div></div></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, prepend: '$', append: '.00')
  end

  test "help messages for default forms" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</small></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, help: 'This is required')
  end

  test "help messages for horizontal forms" do
    expected = %{<div class="form-group row"><label class="col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</small></div></div>}
  ...
  test "help messages to look up I18n automatically" do
    expected = %{<div class="form-group"><label class="" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="text" value="secret" /><small class="form-text text-muted">A good password should be at least six characters long</small></div>}
  ...
  test "help messages to ignore translation when user disables help" do
    expected = %{<div class="form-group"><label class="" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="text" value="secret" /></div>}
  ...
  test "form_group creates a valid structure and allows arbitrary html to be added via a block" do
    ...
    expected = %{<div class="form-group row"><label class="col-sm-2" for="user_nil">Foo</label><div class="col-sm-10"><p class="form-control-static">Bar</p></div></div>}
  ...
  test "form_group renders the label correctly" do
    ...
    expected = %{<div class="form-group row"><label class="col-sm-2 required" for="user_email">Custom Control</label><div class="col-sm-10"><p class="form-control-static">Bar</p></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "form_group overrides the label's 'class' and 'for' attributes if others are passed" do
    ...
    expected = %{<div class="form-group row"><label class="foo col-sm-2" for="bar">Custom Control</label><div class="col-sm-10"><p class="form-control-static">Bar</p></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test 'form_group renders the "error" class and message corrrectly when object is invalid' do
    ...
    expected = %{<div class="form-group"><p class="form-control-static">Bar</p><div class="invalid-feedback">can&#39;t be blank, is too short (minimum is 5 characters)</div></div>}
    assert_equivalent_xml expected, output
  end

  test "adds class to wrapped form_group by a field" do
    expected = %{<div class="form-group none-margin"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="search" /></div>}
  ...
  test "adding an icon to a field" do
    expected = %{<div class="form-group has-feedback"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="email" /><span class="glyphicon glyphicon-ok invalid-feedback"></span></div>}
  ...
  test "single form_group call in horizontal form should not be smash design" do
    ...
    expected = %{<div class="form-group row"><div class="col-sm-10 col-sm-offset-2">Hallo</div></div><div class="form-group row"><label class="col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div></div>}
    assert_equivalent_xml expected, output
  end

  test "adds data-attributes (or any other options) to wrapper" do
    expected = %{<div class="form-group" data-foo="bar"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="search" /></div>}
  ...
  test "passing options to a form control get passed through" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><input autofocus="autofocus" class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
  ...
  test "doesn't throw undefined method error when the content block returns nil" do
    ...
    expected = %{<div class="form-group"><label class="" for="user_nil">Foo</label></div>}
    assert_equivalent_xml expected, output
  end
