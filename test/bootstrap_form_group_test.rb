...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test "changing the label text via the label option parameter" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, label: 'Email Address')
  end

  test "changing the label text via the html_options label hash" do
    expected = %{<div class="form-group"><label class="control-label required" for="user_email">Email Address</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
    assert_dom_equal expected, @builder.text_field(:email, label: {text: 'Email Address'})
  end
  ...
  test "hiding a label" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, hide_label: true)
  end
  ...
  test "adding a custom label class via the label_class parameter" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, label_class: 'btn')
  end

  test "adding a custom label class via the html_options label hash" do
    expected = %{<div class="form-group"><label class="btn control-label required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
    assert_dom_equal expected, @builder.text_field(:email, label: {class: 'btn'})
  end
  ...
  test "adding a custom label and changing the label text via the html_options label hash" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, label: {class: 'btn', text: "Email Address"})
  end
  ...
  test "skipping a label" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, skip_label: true)
  end
  ...
  test "adding prepend text" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, prepend: '@')
  end
  ...
  test "adding append text" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, append: '.00')
  end
  ...
  test "append and prepend button" do
    ...
    assert_dom_equal after_button, @builder.text_field(:email, append: button_src)
    assert_dom_equal before_button, @builder.text_field(:email, prepend: button_src)
    assert_dom_equal both_button, @builder.text_field(:email, append: button_src, prepend: button_src)
  end
  ...
  test "adding both prepend and append text" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, prepend: '$', append: '.00')
  end
  ...
  test "help messages for default forms" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, help: 'This is required')
  end
  ...
  test "help messages for horizontal forms" do
    ...
    assert_dom_equal expected, @horizontal_builder.text_field(:email, help: "This is required")
  end
  ...
  test "help messages to look up I18n automatically" do
    ...
    assert_dom_equal expected, @builder.text_field(:password)
  end
  ...
  test "help messages to ignore translation when user disables help" do
    ...
    assert_dom_equal expected, @builder.text_field(:password, help: false)
  end
  ...
  test "adds class to wrapped form_group by a field" do
    ...
    assert_dom_equal expected, @builder.search_field(:misc, wrapper_class: 'none-margin')
  end
  ...
  test "adds class to wrapped form_group by a field with errors" do
    ...
    assert_dom_equal expected, @builder.email_field(:email, wrapper_class: 'none-margin')
  end
  ...
  test "adding an icon to a field" do
    ...
    assert_dom_equal expected, @builder.email_field(:misc, icon: 'ok')
  end
  ...
  test "adds data-attributes (or any other options) to wrapper" do
    ...
    assert_dom_equal expected, @builder.search_field(:misc, wrapper: { data: { foo: 'bar' } })
  end
  ...
  test "passing options to a form control get passed through" do
    ...
    assert_dom_equal expected, @builder.text_field(:email, autofocus: true)
  end
  ...
  test "custom form group layout option" do
    ...
    assert_dom_equal expected, bootstrap_form_for(@user, layout: :horizontal) { |f| f.email_field :email, layout: :inline }
  end
