...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test "help messages for default forms" do
    expected = %{<div class="form-group"><label class="form-control-label required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</span></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, help: 'This is required')
  end

  test "help messages for horizontal forms" do
    expected = %{<div class="form-group row"><label class="form-control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</span></div></div>}
  ...
  test "help messages to look up I18n automatically" do
    expected = %{<div class="form-group"><label class="form-control-label" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="text" value="secret" /><small class="form-text text-muted">A good password should be at least six characters long</span></div>}
  ...
  test "adds offset for form_group without label" do
    ...
    expected = %{<div class="form-group row"><div class="col-sm-10 col-sm-offset-2"><input class="btn btn-secondary" name="commit" type="submit" value="Update User" /></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "adds offset for form_group without label but specific label_col" do
    ...
    expected = %{<div class="form-group row"><div class="col-sm-8 col-sm-offset-5"><input class="btn btn-secondary" name="commit" type="submit" value="Update User" /></div></div>}
    assert_equivalent_xml expected, output
  end
