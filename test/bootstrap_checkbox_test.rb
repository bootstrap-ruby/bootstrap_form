...
class BootstrapCheckboxTest < ActionView::TestCase
  ...
  test "check_box is wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label: 'I agree to the terms')
  end
  ...
  test "disabled check_box has proper wrapper classes" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label: 'I agree to the terms', disabled: true)
  end
  ...
  test "check_box label allows html" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label: %{I agree to the <a href="#">terms</a>}.html_safe)
  end

  test "check_box accepts a block to define the label" do
    expected = %{<div class="checkbox"><label for="user_terms"><input name="user[terms]" type="hidden" value="0" /><input id="user_terms" name="user[terms]" type="checkbox" value="1" /> I agree to the terms</label></div>}
    assert_dom_equal expected, @builder.check_box(:terms) { "I agree to the terms" }
  end
  ...
  test "check_box accepts a custom label class" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label_class: 'btn')
  end
  ...
  test "check_box responds to checked_value and unchecked_value arguments" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, {label: 'I agree to the terms'}, 'yes', 'no')
  end
  ...
  test "inline checkboxes" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label: 'I agree to the terms', inline: true)
  end
  ...
  test "disabled inline check_box" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, label: 'I agree to the terms', inline: true, disabled: true)
  end
  ...
  test "inline checkboxes with custom label class" do
    ...
    assert_dom_equal expected, @builder.check_box(:terms, inline: true, label_class: 'btn')
  end
  ...
  test 'collection_check_boxes renders the form_group correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, label: 'This is a checkbox collection', help: 'With a help!')
  end
  ...
  test 'collection_check_boxes renders multiple checkboxes correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street)
  end
  ...
  test 'collection_check_boxes renders inline checkboxes correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, inline: true)
  end
  ...
  test 'collection_check_boxes renders with checked option correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, checked: 1)
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, checked: collection.first)
  end
  ...
  test 'collection_check_boxes renders with multiple checked options correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, checked: [1, 2])
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, :street, checked: collection)
  end
  ...
  test 'collection_check_boxes renders multiple checkboxes with labels defined by Proc :text_method correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, Proc.new { |a| a.street.reverse })
  end
  ...
  test 'collection_check_boxes renders multiple checkboxes with values defined by Proc :value_method correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, Proc.new { |a| "address_#{a.id}" }, :street)
  end
  ...
  test 'collection_check_boxes renders multiple checkboxes with labels defined by lambda :text_method correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, :id, lambda { |a| a.street.reverse })
  end
  ...
  test 'collection_check_boxes renders multiple checkboxes with values defined by lambda :value_method correctly' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, lambda { |a| "address_#{a.id}" }, :street)
  end
  ...
  test 'collection_check_boxes renders with checked option correctly with Proc :value_method' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, Proc.new { |a| "address_#{a.id}" }, :street, checked: "address_1")
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, Proc.new { |a| "address_#{a.id}" }, :street, checked: collection.first)
  end
  ...
  test 'collection_check_boxes renders with multiple checked options correctly with lambda :value_method' do
    ...
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, lambda { |a| "address_#{a.id}" }, :street, checked: ["address_1", "address_2"])
    assert_dom_equal expected, @builder.collection_check_boxes(:misc, collection, lambda { |a| "address_#{a.id}" }, :street, checked: collection)
  end
