...
class BootstrapOtherComponentsTest < ActionView::TestCase
  ...
  test "static control" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><p class="form-control-static">steve@example.com</p></div></div>}
  ...
  test "static control doesn't require an actual attribute" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2" for="user_">My Label</label><div class="col-sm-10"><p class="form-control-static">this is a test</p></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "static control doesn't require a name" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2" for="user_">Custom Label</label><div class="col-sm-10"><p class="form-control-static">Custom Control</p></div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "custom control does't wrap given block in a p tag" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10">this is a test</div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "custom control doesn't require an actual attribute" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2" for="user_">My Label</label><div class="col-sm-10">this is a test</div></div>}
    assert_equivalent_xml expected, output
  end
  ...
  test "custom control doesn't require a name" do
    ...
    expected = %{<div class="form-group"><label class="form-control-label col-sm-2" for="user_">Custom Label</label><div class="col-sm-10">Custom Control</div></div>}
    assert_equivalent_xml expected, output
  end
