...
class BootstrapFormTest < ActionView::TestCase
  ...
  test "bootstrap_form_tag allows an empty name for checkboxes" do
    checkbox = if ::Rails::VERSION::STRING >= '5.1'
      %{<div class="form-check"><label for="misc"><input name="misc" type="hidden" value="0" /><input class="form-check-input" id="misc" name="misc" type="checkbox" value="1" /> Misc</label></div>}
    else
      %{<div class="form-check"><label for="_misc"><input name="[misc]" type="hidden" value="0" /><input class="form-check-input" id="_misc" name="[misc]" type="checkbox" value="1" /> Misc</label></div>}
    end
