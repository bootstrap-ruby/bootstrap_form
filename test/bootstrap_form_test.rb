...
class BootstrapFormTest < ActionView::TestCase
  ...
  test "custom label width for horizontal forms" do
    ...
    assert_equal expected, bootstrap_form_for(@user, style: :horizontal) { |f| f.email_field :email, left: 'col-sm-1' }
  end
  ...
  test "custom input width for horizontal forms" do
    ...
    assert_equal expected, bootstrap_form_for(@user, style: :horizontal) { |f| f.email_field :email, right: 'col-sm-5' }
  end
