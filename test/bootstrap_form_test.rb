...
class BootstrapFormTest < ActionView::TestCase
  ...
  test "text fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_email\">Email</label><div class=\"controls\"><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /></div></div>}
    assert_equal expected, @builder.text_field(:email)
  end

  test "password fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_password\">Password</label><div class=\"controls\"><input class=\"form-control\" id=\"user_password\" name=\"user[password]\" type=\"text\" value=\"secret\" /></div></div>}
    assert_equal expected, @builder.text_field(:password)
  end

  test "text areas are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_comments\">Comments</label><div class=\"controls\"><textarea class=\"form-control\" id=\"user_comments\" name=\"user[comments]\">\nmy comment</textarea></div></div>}
    assert_equal expected, @builder.text_area(:comments)
  end

  test "file fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_misc\">Misc</label><div class=\"controls\"><input class=\"form-control\" id=\"user_misc\" name=\"user[misc]\" type=\"file\" /></div></div>}
    assert_equal expected, @builder.file_field(:misc)
  end

  test "number fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_misc\">Misc</label><div class=\"controls\"><input class=\"form-control\" id=\"user_misc\" name=\"user[misc]\" type=\"number\" /></div></div>}
    assert_equal expected, @builder.number_field(:misc)
  end

  test "email fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_misc\">Misc</label><div class=\"controls\"><input class=\"form-control\" id=\"user_misc\" name=\"user[misc]\" type=\"email\" /></div></div>}
    assert_equal expected, @builder.email_field(:misc)
  end

  test "telephone/phone fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_misc\">Misc</label><div class=\"controls\"><input class=\"form-control\" id=\"user_misc\" name=\"user[misc]\" type=\"tel\" /></div></div>}
  ...
  test "url fields are wrapped correctly" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_misc\">Misc</label><div class=\"controls\"><input class=\"form-control\" id=\"user_misc\" name=\"user[misc]\" type=\"url\" /></div></div>}
    assert_equal expected, @builder.url_field(:misc)
  end

  test "selects are wrapped correctly (select)" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_status\">Status</label><div class=\"controls\"><select id=\"user_status\" name=\"user[status]\"><option value=\"1\">activated</option>\n<option value=\"2\">blocked</option></select></div></div>}
    assert_equal expected, @builder.select(:status, [['activated', 1], ['blocked', 2]])
  end

  test "selects are wrapped correctly (collection_select)" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_status\">Status</label><div class=\"controls\"><select id=\"user_status\" name=\"user[status]\"></select></div></div>}
  ...
  test "changing the label text" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_email\">Email Address</label><div class=\"controls\"><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /></div></div>}
    assert_equal expected, @builder.text_field(:email, label: 'Email Address')
  end

  test "render the field without label" do
    expected = %{<div class=\"form-group\"><div class=\"controls\"><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /></div></div>}
  ...
  test "adding prepend text" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_email\">Email</label><div class=\"controls\"><div class=\"input-prepend\"><span class=\"add-on\">Gmail</span><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /></div></div></div>}
    assert_equal expected, @builder.text_field(:email, prepend: 'Gmail')
  end

  test "adding append text" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_email\">Email</label><div class=\"controls\"><div class=\"input-append\"><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /><span class="add-on">Gmail</span></div></div></div>}
    assert_equal expected, @builder.text_field(:email, append: 'Gmail')
  end

  test "passing other options to a field get passed through" do
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"user_email\">Email</label><div class=\"controls\"><input autofocus=\"autofocus\" class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" value=\"steve@example.com\" /></div></div>}
  ...
  test "control_group creates a valid structure and allows arbitrary html to be added via a block" do
    ...
    expected = %{<div class="form-group"><div class="controls"><span>custom control here</span></div></div>}
  ...
  test "control_group renders the options for div.control_group" do
    ...
    expected = %{<div class="form-group" id="foo"><div class="controls"><span>custom control here</span></div></div>}
    assert_equal expected, output
  end

  test "control_group overrides the form-group class if another is passed" do
  ...
  test "control_group renders the label correctly" do
    ...
    expected = %{<div class="form-group"><label class="control-label" for="user_email">Custom Control</label><div class="controls"><span>custom control here</span></div></div>}
    assert_equal expected, output
  end
  ...
  test "control_group overrides the label's 'class' and 'for' attributes if others are passed" do
    ...
    expected = %{<div class="form-group"><label class="foo" for="bar">Custom Control</label><div class="controls"><span>custom control here</span></div></div>}
    assert_equal expected, output
  end
  ...
  test "control_group label's 'for' attribute should be empty if no name was passed" do
    ...
    expected = %{<div class="form-group"><label class="control-label" for="">Custom Control</label><div class="controls"><span>custom control here</span></div></div>}
    assert_equal expected, output
  end
  ...
  test 'control_group renders the "error" class and message corrrectly when object is invalid' do
    ...
    expected = %{<div class="form-group has-error"><div class="controls"><span>custom control here</span><span class="help-block">can&#39;t be blank, is too short (minimum is 5 characters)</span></div></div>}
    assert_equal expected, output
  end
  ...
  test "the field is wrapped with div.field_with_errors when form_for is used" do
    ...
    expected = %{<form accept-charset=\"UTF-8\" action=\"/users\" class=\"new_user\" id=\"new_user\" method=\"post\"><div style=\"margin:0;padding:0;display:inline\"><input name=\"utf8\" type=\"hidden\" value=\"&#x2713;\" /></div><div class=\"form-group has-error\"><div class=\"field_with_errors\"><label class=\"control-label\" for=\"user_email\">Email</label></div><div class=\"controls\"><div class=\"field_with_errors\"><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" /></div><span class=\"help-block\">can&#39;t be blank, is too short (minimum is 5 characters)</span></div></div></form>}
    assert_equal expected, output
  end
  ...
  test "allows the form object to be nil" do
    ...
    expected = %{<div class=\"form-group\"><label class=\"control-label\" for=\"other_model_email\">Email</label><div class=\"controls\"><input class=\"form-control\" id=\"other_model_email\" name=\"other_model[email]\" type=\"text\" /></div></div>}
    assert_equal expected, builder.text_field(:email)
  end
end
