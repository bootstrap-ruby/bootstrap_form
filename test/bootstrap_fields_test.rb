...
class BootstrapFieldsTest < ActionView::TestCase
  ...
  test "color fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="color" value="#000000" /></div>}
    assert_equivalent_xml expected, @builder.color_field(:misc)
  end

  test "date fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="date" /></div>}
    assert_equivalent_xml expected, @builder.date_field(:misc)
  end

  test "date time fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="datetime" /></div>}
    assert_equivalent_xml expected, @builder.datetime_field(:misc)
  end

  test "date time local fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="datetime-local" /></div>}
    assert_equivalent_xml expected, @builder.datetime_local_field(:misc)
  end

  test "email fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="email" /></div>}
    assert_equivalent_xml expected, @builder.email_field(:misc)
  end

  test "file fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input id="user_misc" name="user[misc]" type="file" /></div>}
  ...
  test "month local fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="month" /></div>}
    assert_equivalent_xml expected, @builder.month_field(:misc)
  end

  test "number fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="number" /></div>}
    assert_equivalent_xml expected, @builder.number_field(:misc)
  end

  test "password fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="password" /><small class="form-text text-muted">A good password should be at least six characters long</small></div>}
    assert_equivalent_xml expected, @builder.password_field(:password)
  end

  test "phone/telephone fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="tel" /></div>}
  ...
  test "range fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="range" /></div>}
    assert_equivalent_xml expected, @builder.range_field(:misc)
  end

  test "search fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="search" /></div>}
    assert_equivalent_xml expected, @builder.search_field(:misc)
  end

  test "text areas are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_comments">Comments</label><textarea class="form-control" id="user_comments" name="user[comments]">\nmy comment</textarea></div>}
    assert_equivalent_xml expected, @builder.text_area(:comments)
  end

  test "text fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /></div>}
    assert_equivalent_xml expected, @builder.text_field(:email)
  end

  test "time fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="time" /></div>}
    assert_equivalent_xml expected, @builder.time_field(:misc)
  end

  test "url fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="url" /></div>}
    assert_equivalent_xml expected, @builder.url_field(:misc)
  end

  test "week fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="" for="user_misc">Misc</label><input class="form-control" id="user_misc" name="user[misc]" type="week" /></div>}
