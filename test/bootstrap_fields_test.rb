...
class BootstrapFieldsTest < ActionView::TestCase
  ...
  test "color fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.color_field(:misc)
  end
  ...
  test "date fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.date_field(:misc)
  end
  ...
  test "date time fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.datetime_field(:misc)
  end
  ...
  test "date time local fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.datetime_local_field(:misc)
  end
  ...
  test "email fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.email_field(:misc)
  end
  ...
  test "file fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.file_field(:misc)
  end

  test "hidden fields are supported" do
    expected = %{<input id="user_misc" name="user[misc]" type="hidden" />}
    assert_dom_equal expected, @builder.hidden_field(:misc)
  end
  ...
  test "month local fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.month_field(:misc)
  end
  ...
  test "number fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.number_field(:misc)
  end
  ...
  test "password fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.password_field(:password)
  end
  ...
  test "phone/telephone fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.phone_field(:misc)
    assert_dom_equal expected, @builder.telephone_field(:misc)
  end
  ...
  test "range fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.range_field(:misc)
  end
  ...
  test "search fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.search_field(:misc)
  end
  ...
  test "text areas are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.text_area(:comments)
  end
  ...
  test "time fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.time_field(:misc)
  end
  ...
  test "url fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.url_field(:misc)
  end
  ...
  test "week fields are wrapped correctly" do
    ...
    assert_dom_equal expected, @builder.week_field(:misc)
  end
