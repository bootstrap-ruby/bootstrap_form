...
if ::Rails::VERSION::STRING >= "5.1"
  ...
  class BootstrapFormWithCheckboxTest < ActionView::TestCase
    ...
    test "collection_check_boxes renders the form_group correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, label: "This is a checkbox collection", help: "With a help!")
    end
    ...
    test "collection_check_boxes renders multiple checkboxes correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street)
    end
    ...
    HTML
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, inline: true)
    end
    ...
    test "collection_check_boxes renders with checked option correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, checked: 1)
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, checked: collection.first)
    end
    ...
    test "collection_check_boxes renders with multiple checked options correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, checked: [1, 2])
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, :street, checked: collection)
    end
    ...
    HTML
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :street, :street)
    end
    ...
    test "collection_check_boxes renders multiple checkboxes with labels defined by Proc :text_method correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, proc { |a| a.street.reverse })
    end
    ...
    test "collection_check_boxes renders multiple checkboxes with values defined by Proc :value_method correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, proc { |a| "address_#{a.id}" }, :street)
    end
    ...
    test "collection_check_boxes renders multiple checkboxes with labels defined by lambda :text_method correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, :id, ->(a) { a.street.reverse })
    end
    ...
    test "collection_check_boxes renders multiple checkboxes with values defined by lambda :value_method correctly" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, ->(a) { "address_#{a.id}" }, :street)
    end
    ...
    test "collection_check_boxes renders with checked option correctly with Proc :value_method" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, proc { |a| "address_#{a.id}" }, :street, checked: "address_1")
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, proc { |a| "address_#{a.id}" }, :street, checked: collection.first)
    end
    ...
    test "collection_check_boxes renders with multiple checked options correctly with lambda :value_method" do
      ...
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, ->(a) { "address_#{a.id}" }, :street, checked: %w(address_1 address_2))
      assert_equivalent_xml remove_default_ids_for_rails_5_1(expected),
    @form_with_builder.collection_check_boxes(:misc, collection, ->(a) { "address_#{a.id}" }, :street, checked: collection)
    end
  end
end
