  ...
  class BootstrapRichTextAreaTest < ActionView::TestCase
    ...
    test "rich text areas are wrapped correctly" do
      ...
      <div class="mb-3">
        ...
        <trix-editor id="user_life_story" data-blob-url-template="http://test.host/rails/active_storage/blobs/redirect/:signed_id/:filename" data-direct-upload-url="http://test.host/rails/active_storage/direct_uploads" input="user_life_story_trix_input_user" class="trix-content form-control" />
      </div>
      HTML
