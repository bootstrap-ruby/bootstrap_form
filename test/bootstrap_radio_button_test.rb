...
class BootstrapRadioButtonTest < ActionView::TestCase
  ...
  test "radio_button is wrapped correctly" do
    expected = %{<div class="radio"><label for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label></div>}
  ...
  test "radio_button disabled label is set correctly" do
    expected = %{<div class="radio disabled"><label for="user_misc_1"><input disabled="disabled" type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label></div>}
  ...
  test "radio_button label class is set correctly" do
    expected = %{<div class="radio"><label class="btn" for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label></div>}
  ...
  test "radio_button inline label is set correctly" do
    expected = %{<label class="radio-inline" for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label>}
  ...
  test "radio_button disabled inline label is set correctly" do
    expected = %{<label class="radio-inline disabled" for="user_misc_1"><input disabled="disabled" type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label>}
  ...
  test "radio_button inline label class is set correctly" do
    expected = %{<label class="radio-inline btn" for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> This is a radio button</label>}
  ...
  test 'collection_radio_buttons renders the form_group correctly' do
    ...
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">This is a radio button collection</label><div class="radio"><label for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> Foobar</label></div><span class="help-block">With a help!</span></div>}
  ...
  test 'collection_radio_buttons renders multiple radios correctly' do
    ...
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">Misc</label><div class="radio"><label for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> Foo</label></div><div class="radio"><label for="user_misc_2"><input type="radio" value="2" name="user[misc]" id="user_misc_2" /> Bar</label></div></div>}
  ...
  test 'collection_radio_buttons renders inline radios correctly' do
    collection = [Address.new(id: 1, street: 'Foo'), Address.new(id: 2, street: 'Bar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">Misc</label><label class="radio-inline" for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> Foo</label><label class="radio-inline" for="user_misc_2"><input type="radio" value="2" name="user[misc]" id="user_misc_2" /> Bar</label></div>}
  ...
  test 'collection_radio_buttons renders with checked option correctly' do
    collection = [Address.new(id: 1, street: 'Foo'), Address.new(id: 2, street: 'Bar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">Misc</label><div class="radio"><label for="user_misc_1"><input type="radio" value="1" checked="checked" name="user[misc]" id="user_misc_1" /> Foo</label></div><div class="radio"><label for="user_misc_2"><input type="radio" value="2" name="user[misc]" id="user_misc_2" /> Bar</label></div></div>}
  ...
  test 'collection_radio_buttons renders label defined by Proc correctly' do
    collection = [Address.new(id: 1, street: 'Foobar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">This is a radio button collection</label><div class="radio"><label for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> rabooF</label></div><span class="help-block">With a help!</span></div>}
  ...
  test 'collection_radio_buttons renders value defined by Proc correctly' do
    collection = [Address.new(id: 1, street: 'Foobar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">This is a radio button collection</label><div class="radio"><label for="user_misc_address_1"><input type="radio" value="address_1" name="user[misc]" id="user_misc_address_1" /> Foobar</label></div><span class="help-block">With a help!</span></div>}
  ...
  test 'collection_radio_buttons renders multiple radios with label defined by Proc correctly' do
    collection = [Address.new(id: 1, street: 'Foo'), Address.new(id: 2, street: 'Bar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">Misc</label><div class="radio"><label for="user_misc_1"><input type="radio" value="1" name="user[misc]" id="user_misc_1" /> ooF</label></div><div class="radio"><label for="user_misc_2"><input type="radio" value="2" name="user[misc]" id="user_misc_2" /> raB</label></div></div>}
  ...
  test 'collection_radio_buttons renders multiple radios with value defined by Proc correctly' do
    collection = [Address.new(id: 1, street: 'Foo'), Address.new(id: 2, street: 'Bar')]
    expected = %{<div class="form-group"><label class="control-label" for="user_misc">Misc</label><div class="radio"><label for="user_misc_address_1"><input type="radio" value="address_1" name="user[misc]" id="user_misc_address_1" /> Foo</label></div><div class="radio"><label for="user_misc_address_2"><input type="radio" value="address_2" name="user[misc]" id="user_misc_address_2" /> Bar</label></div></div>}
